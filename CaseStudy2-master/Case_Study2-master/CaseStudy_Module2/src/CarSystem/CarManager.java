...
public class CarManager implements Serializable {
    ...
    public CarManager() {
        cars = ioTextFile1.readFile("CaseStudy2-master/Case_Study2-master/CaseStudy_Module2/src/File/Storage.txt");
        carUsers = ioTextFile1.readFile("CaseStudy2-master/Case_Study2-master/CaseStudy_Module2/src/File/CartUser.txt");
        users = ioTextFile.readFile("CaseStudy2-master/Case_Study2-master/CaseStudy_Module2/src/File/UserAccount.txt");
        resetStaticIndex();
    }
    ...
    public void add(ArrayList<Category> categories, Scanner scanner) {
        try {
            ...
            ioTextFile1.writeFile(cars, "CaseStudy2-master/Case_Study2-master/CaseStudy_Module2/src/File/Storage.txt");
            resetStaticIndex();
    ...
    public void displayCartUser() {
        ioTextFile1.readFile("CaseStudy2-master/Case_Study2-master/CaseStudy_Module2/src/File/CartUser.txt");
        if (carUsers.isEmpty()) {
            System.out.println("⏰ Empty car!");
        } else {
            System.out.printf("%-10s%-20s%-15s%-20s%s", "ID", "Name", "Price", "Quantity", "Category\n");
...
//    }
    ...
    public void addCarByUser() {
        ioTextFile1.readFile("CaseStudy2-master/Case_Study2-master/CaseStudy_Module2/src/File/Storage.txt");
        try {
            ...
            for (Car car : cars) {
                if (car.getId().equals(id)) {
                    if (car.getQuantity() > quantity) {
                        ...
                        ioTextFile1.writeFile(carUsers, "CaseStudy2-master/Case_Study2-master/CaseStudy_Module2/src/File/CartUser.txt");
